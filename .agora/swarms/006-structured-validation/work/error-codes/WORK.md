...
status-by: null
status-at: null
acceptance-criteria: {"outcome":"Valid fixtures pass; unknown schema/duplicate ids/unsupported operations/excessive size-or-depth each fail with a distinct stable code; no partial execution after failure"}
